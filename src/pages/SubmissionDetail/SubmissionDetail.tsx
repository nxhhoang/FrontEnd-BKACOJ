...
export default function SubmissionDetailPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 p-6">
      <Link to={-1 as any} className="text-blue-600 hover:underline mb-4 inline-block font-medium">
        &larr; Back
      </Link>
                  ...
                  <tbody>
                    {detail.verdict_case?.map((v, i) => (
                      <tr key={i} className="border-b last:border-0 hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2 text-center text-gray-600">{bytesToMB(detail.memory_usage_case[i])}</td>
